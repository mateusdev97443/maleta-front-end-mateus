...
Este capítulo ensina entender contrato entre front-end e fonte de dados no contexto de JavaScript vanilla para Front-end. A ideia central é manter a página utilizável enquanto uma ação aguarda tempo, rede ou resposta externa.
...
```js
// Front-end pede: /users/1
// API responde: { "id": 1, "name": "Ana" }
```
...
Liste quais dados sua tela precisa antes de escolher uma API.
