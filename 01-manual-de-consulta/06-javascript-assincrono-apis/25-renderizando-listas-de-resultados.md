...
Este capítulo ensina criar HTML repetido a partir de array no contexto de JavaScript vanilla para Front-end. A ideia central é manter a página utilizável enquanto uma ação aguarda tempo, rede ou resposta externa.
...
Renderize uma lista e trate o caso de array vazio.
