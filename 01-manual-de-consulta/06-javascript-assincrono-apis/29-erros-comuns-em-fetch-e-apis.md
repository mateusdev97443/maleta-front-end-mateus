...
Este capítulo ensina reconhecer falhas frequentes antes de depurar no contexto de JavaScript vanilla para Front-end. A ideia central é manter a página utilizável enquanto uma ação aguarda tempo, rede ou resposta externa.
...
Liste três erros possíveis em uma tela que consome API.
