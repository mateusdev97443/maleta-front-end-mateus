...
Alinhamento e espaçamento são decisões de design e de código que mantêm o layout claro em qualquer tela. O objetivo deste capítulo é transformar o assunto em decisões práticas: o que usar, quando usar e quais cuidados tomar.
